<div class="wrap">
    ...
    <form method="post" action="options.php">
        <?php 
        @settings_fields('wpckan-group');
        @do_settings_fields('wpckan', 'wpckan-group');
        ...
        <table class="form-table">
            <th scope="row">
                <label>
                    <h3><?php _e('Connecting to CKAN', 'wpckan') ?></h3>
                </label>
            </th>
            <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    foreach (get_post_types() as $post_type) {
                        ...
                        ?>
                        <p>
                            <input type="checkbox" name="<?php echo $settings_name ?>" id="<?php echo $settings_name ?>" <?php if ($GLOBALS['wpckan_options']->get_option($settings_name))  echo 'checked="true"'; ?>><?php echo $post_type ?></input>
                        </p>
                    <?php } ?>
                </td>
            </tr>
            ...
            <th scope="row">
                <label>
                    <h3><?php _e('Dataset detail pages', 'wpckan') ?></h3>
                </label>
            </th>
            <tr valign="top">
