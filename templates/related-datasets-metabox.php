...
<?php if (wpckan_validate_settings_read()){ ?>
  ...
  <p>
    <input id="wpckan_related_datasets_add_field" class="new typeahead" onInput="wpckan_related_dataset_metabox_on_input();" wpckan-base-url="<?php echo $GLOBALS['options']->get_option('wpckan_setting_ckan_url'); ?>" wpckan-api-url="<?php echo wpckan_get_ckan_settings()["baseUrl"]; ?>" placeholder="Type for suggestions" type="text" name="wpckan_related_datasets_add_field" value="" size="25" />
